...
import presentations.FrameManager.MyButton;
...
public class FrameManager extends JFrame {
    ...
    public FrameManager() {
        ...
        //JMenuItem mntmBaoCaoCac = new JMenuItem("Bao Cao ");
...
//		contentPane.add(lblStatus, BorderLayout.SOUTH);
    ...
    public void management(int id, String name, int activited, int role) {
        if (activited == 1) {
			...
			JOptionPane.showMessageDialog(null, "Tài khoản của bạn chưa được kích hoạt, Xin liên hệ với quản trị viên!",
					"Kích hoạt tài khoản!", JOptionPane.ERROR_MESSAGE);
        }
        btnAccount.removeActionListener(btnAccount.getActionListeners()[0]);
        btnAccount.addActionListener(new ActionListener() {
